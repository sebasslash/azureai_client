...
# Unit tests for AzureAIClient::ChatCompletionsCreateRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::ChatCompletionsCreateRequestMessagesInner do
  let(:instance) { AzureAIClient::ChatCompletionsCreateRequestMessagesInner.new }
  ...
  describe 'test an instance of ChatCompletionsCreateRequestMessagesInner' do
    it 'should create an instance of ChatCompletionsCreateRequestMessagesInner' do
      expect(instance).to be_instance_of(AzureAIClient::ChatCompletionsCreateRequestMessagesInner)
    end
  end
