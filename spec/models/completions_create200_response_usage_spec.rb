...
# Unit tests for AzureAIClient::CompletionsCreate200ResponseUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::CompletionsCreate200ResponseUsage do
  let(:instance) { AzureAIClient::CompletionsCreate200ResponseUsage.new }
  ...
  describe 'test an instance of CompletionsCreate200ResponseUsage' do
    it 'should create an instance of CompletionsCreate200ResponseUsage' do
      expect(instance).to be_instance_of(AzureAIClient::CompletionsCreate200ResponseUsage)
    end
  end
