...
# Unit tests for AzureAIClient::ChatCompletionsCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::ChatCompletionsCreateRequest do
  let(:instance) { AzureAIClient::ChatCompletionsCreateRequest.new }
  ...
  describe 'test an instance of ChatCompletionsCreateRequest' do
    it 'should create an instance of ChatCompletionsCreateRequest' do
      expect(instance).to be_instance_of(AzureAIClient::ChatCompletionsCreateRequest)
    end
  end
