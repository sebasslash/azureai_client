...
# Unit tests for AzureAIClient::CompletionsCreate200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::CompletionsCreate200Response do
  let(:instance) { AzureAIClient::CompletionsCreate200Response.new }
  ...
  describe 'test an instance of CompletionsCreate200Response' do
    it 'should create an instance of CompletionsCreate200Response' do
      expect(instance).to be_instance_of(AzureAIClient::CompletionsCreate200Response)
    end
  end
