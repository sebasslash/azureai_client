...
# Unit tests for AzureAIClient::ChatCompletionsCreate200ResponseUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::ChatCompletionsCreate200ResponseUsage do
  let(:instance) { AzureAIClient::ChatCompletionsCreate200ResponseUsage.new }
  ...
  describe 'test an instance of ChatCompletionsCreate200ResponseUsage' do
    it 'should create an instance of ChatCompletionsCreate200ResponseUsage' do
      expect(instance).to be_instance_of(AzureAIClient::ChatCompletionsCreate200ResponseUsage)
    end
  end
