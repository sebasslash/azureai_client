...
# Unit tests for AzureAIClient::EmbeddingsCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::EmbeddingsCreateRequest do
  let(:instance) { AzureAIClient::EmbeddingsCreateRequest.new }

  describe 'test an instance of EmbeddingsCreateRequest' do
    it 'should create an instance of EmbeddingsCreateRequest' do
      expect(instance).to be_instance_of(AzureAIClient::EmbeddingsCreateRequest)
    end
  end
