...
# Unit tests for AzureAIClient::ChatCompletionsCreate200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::ChatCompletionsCreate200Response do
  let(:instance) { AzureAIClient::ChatCompletionsCreate200Response.new }
  ...
  describe 'test an instance of ChatCompletionsCreate200Response' do
    it 'should create an instance of ChatCompletionsCreate200Response' do
      expect(instance).to be_instance_of(AzureAIClient::ChatCompletionsCreate200Response)
    end
  end
