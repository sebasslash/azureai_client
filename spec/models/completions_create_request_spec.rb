...
# Unit tests for AzureAIClient::CompletionsCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::CompletionsCreateRequest do
  let(:instance) { AzureAIClient::CompletionsCreateRequest.new }

  describe 'test an instance of CompletionsCreateRequest' do
    it 'should create an instance of CompletionsCreateRequest' do
      expect(instance).to be_instance_of(AzureAIClient::CompletionsCreateRequest)
    end
  end
