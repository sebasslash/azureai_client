...
# Unit tests for AzureAIClient::CompletionsCreate200ResponseChoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AzureAIClient::CompletionsCreate200ResponseChoicesInner do
  let(:instance) { AzureAIClient::CompletionsCreate200ResponseChoicesInner.new }
  ...
  describe 'test an instance of CompletionsCreate200ResponseChoicesInner' do
    it 'should create an instance of CompletionsCreate200ResponseChoicesInner' do
      expect(instance).to be_instance_of(AzureAIClient::CompletionsCreate200ResponseChoicesInner)
    end
  end
